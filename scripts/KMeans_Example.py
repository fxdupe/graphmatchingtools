...
from graph_matching_tools.utils.permutations import get_permutation_matrix_from_dictionary
...
if __name__ == "__main__":
    default_to_graph_folder = "/home/rohit/PhD_Work/GM_my_version/Graph_matching/data/simu_graph/simu_test/"
    parser = argparse.ArgumentParser(description="Segmentation from learning method.")
    parser.add_argument("-g", "--graph_dir", help="The directory with the graph",
                        type=str, default=default_to_graph_folder)
    parser.add_argument("-k", "--kmeans_cluster", help="The number of clusters seeks by KMean",
    ...
    for trial in trials:
        ...
        for folder in all_files:
            ...
            if os.path.isdir(path_to_graph_folder + trial + "/" + folder):
                ...
                path_to_groundtruth_ref = path_to_graph_folder + "/" + trial + "/" +\
                                          folder + "/permutation_to_ref_graph.gpickle"

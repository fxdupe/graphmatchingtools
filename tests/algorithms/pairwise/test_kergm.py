...
class TestKerGM(TestCase):
    ...
    def test_kergm_method1(self):
        ...
        r, c = kergm.kergm_method(gradient, 2, num_alpha=10, entropy_gamma=50.0, iterations=4,
                                  inner_iterations=10000, inner_tolerance=1e-6)
        self.assertTrue(np.linalg.norm(r - np.array([0, 1])) < 1e-5, "Testing matching (1)")
    ...
    def test_kergm_method2(self):
        ...
        r, c = kergm.kergm_method(gradient, 3, num_alpha=20, entropy_gamma=50.0, iterations=1000,
                                  tolerance=1e-10, inner_iterations=10000, inner_tolerance=1e-6, epsilon=2e-16)
